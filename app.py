...
# Create a dictionary for storing the generated maps under the name of the corresponding sheet in excel.
map_dict = {}
...
# Define a function that creates maps for all minerals within the category.
...
#______________________________________________________________
    ...
    # Function returns the HTML template corresponding to the mineral category. Jinja will reference the Map Dictionary using the same variable name.
...
#______________________________________________________________
    ...
    # read an individual excel sheet to a Pandas dataframe variable. The sheet name corresponds to the mineral name.
    df_talc_steatite_pyro = pd.read_excel("6.5. Share_of_World_Mineral_Production_2022_by_Countries.xlsx", sheet_name="Talc, Steatite & Pyrophyllite", skiprows=[0])
